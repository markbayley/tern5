  ...
  return (
    ...
    >
      ...
      <Row>
        <Col>
          <div
            className="row justify-content-center align-items-end footer-partners-list"
          ...
          >
            ...
            <div className="col-sm-2">
              <img
                src="https://www.tern.org.au/wp-content/uploads/james-cook-logo@2x.png"
                alt=""
                width="145"
              />
            </div>
            ...
            <div className="col-sm-2">
              <img
                src="https://www.tern.org.au/wp-content/uploads/ua-logo@2x.png"
                alt=""
                width="145"
              />
            </div>
