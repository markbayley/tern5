                ...
                <div class="container">
                    <div class="row justify-content-center">
                                ...
                                <div class="col">
                                    <div class="row login-form-container">
                                        <div id="kc-form" class="col">
                                            <div id="kc-form-wrapper" class=" row justify-content-center">
                                                <form id="kc-form-login" onSubmit="login.disabled = true; return true;"
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <input tabindex="1" id="username" class="" name="username" value="" type="text" autofocus
                                                            autocomplete="off" />
                                                    </div>

                                                    <div class="">
                                                        <label for="password" class="">Password</label>
                                                        <input tabindex="2" id="password" class="" name="password" type="password"
                                                            autocomplete="off" />
                                                    </div>
                                                    ...
                                                    <div class=" ">
                                                        ...
                                                        <div class="">
                                                            <span><a tabindex="5"
                                                                href="/auth/realms/tern/login-actions/reset-credentials?client_id=account&amp;tab_id=Q8XsMUIOKeg">Forgot
                                                                Password?</a></span>
                                                        </div>
                                            ...
                                            <div id="kc-social-providers" class=" row justify-content-center">
                                                <ul class="login-pf-social list-unstyled login-pf-social-all ">
                                                    <li class="login-pf-social-link"><a
                                                        ...
                                                        id="zocial-aaf" class="zocial oidc"> <span>AAF</span></a></li>
                                                    <li class="login-pf-social-link"><a
                                                        ...
                                                        id="zocial-google" class="zocial oidc"> <span>Google</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div >
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="row login-text-container" style={{ height: "100%", lineHeight: "2", padding: "2em" }}>
                                <h3>Have you signed up for our newsletter?</h3>
                                <p>Stay connected and see how other researchers are utilising TERN's infrastructure and data.</p>
                                <p>We will send you project updates, data releases, research findings, and user stories direct to your
                                inbox.</p>
                            </div>
                        </div>
                    </div >
